            ...
            {siteConfig.locations.map((location, index) => (
              <Card key={location.name} className="overflow-hidden group hover:shadow-xl transition-shadow duration-300">
                ...
                <CardContent className="p-8">
                  {/* Location Name */}
                  <h2 className="font-display text-2xl font-bold text-[#6682a3] mb-4 group-hover:text-[#c9826d] transition-colors">
                    {location.name}
                  </h2>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <a
                          ...
                          className="text-[#c9826d] hover:underline font-medium"
                        >
                          {location.phone}
                        </a>
                      </div>
