...
export const metadata: Metadata = {
  title: "Register",
  description: `Create your ${siteConfig.shortName} patient portal account to manage appointments, view medical records, and more.`,
}
      ...
      <div className="hidden lg:flex flex-1 bg-[#003366] relative items-center justify-center p-12">
        ...
        <div className="relative z-10 text-white text-center max-w-md">
          ...
          <p className="text-gray-300 mb-8">
            Create your account to access a world of healthcare convenience at your fingertips.
          </p>
